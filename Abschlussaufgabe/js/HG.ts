...
namespace Abschlussaufgabe {
    ...
    export class Background {
        ...
        drawBoden(_x: number, _y: number): void{
            crc2.moveTo(_x, _y);
            crc2.lineTo(405, 620);
            crc2.lineWidth = 5;
            crc2.stroke();
            crc2.fillStyle = "#fff3e0";
            crc2.fillRect(0, 620, 405, 100);
        }
        ...
        drawHill(_x: number, _y: number): void {
            crc2.beginPath();
            crc2.moveTo(_x, _y);
            crc2.quadraticCurveTo(90, 450, 180, 550);
            crc2.moveTo(180, 550);
            crc2.quadraticCurveTo(340, 430, 405, 550);
            crc2.closePath();
            crc2.fillStyle = "#3f7631";
            crc2.fill();
            crc2.fillRect(0, 550, 405, 185);
        }
        ...
        drawField(_x: number, _y: number): void {
            crc2.beginPath();
            crc2.moveTo(_x, _y);
            crc2.quadraticCurveTo(100, 550, 202, 600);
            crc2.closePath();
            crc2.fillStyle = "#4faf36";
            crc2.fill();
            crc2.beginPath();
            crc2.moveTo(202, 600);
            crc2.quadraticCurveTo(300, 560, 405, 600);
            crc2.closePath();
            crc2.fill();
            crc2.fillRect(0, 600, 405, 220);
        }
